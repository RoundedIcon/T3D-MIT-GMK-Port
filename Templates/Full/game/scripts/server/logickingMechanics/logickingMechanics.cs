...
datablock SoftBodyData(test : PhysSoftSphere)
{
   attachedPoints[0] = "0 0 1";
   shapeFile = "art/shapes/Cheetah/Cheetah_Body.cached.dts";
   cameraMaxDist = "6.08057";
};

datablock SoftBodyData(flag3 : PhysFlag)
{
};

datablock SoftBodyData(flag2 : PhysFlag)
{
};
